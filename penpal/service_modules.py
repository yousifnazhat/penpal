    ...
    "snmp": ServiceModule(
        ...
        templates=(
            ModuleCommandTemplate(
                ...
                args=("nmap", "-sU", "-sV", "-p161", "--script", "snmp-info", "{target_host}", "-oA", "{output_prefix}"),
                service_key="udp/161",
    ...
    "web": ServiceModule(
        ...
        templates=(
            ModuleCommandTemplate(
                ...
                args=("nmap", "-sV", "-sC", "-p{web_ports}", "--script", "http-title,http-server-header", "{target_host}", "-oA", "{output_prefix}"),
            ...
            ModuleCommandTemplate(
                ...
                args=("ffuf", "-u", "{web_url}", "-H", "Host: FUZZ.{domain}", "-w", "{wordlist}", "-mc", "all", "-fs", "{baseline_size}"),
                service_key="tcp/{first_web_port}",
    ...
    "smb": ServiceModule(
        ...
        templates=(
            ModuleCommandTemplate(
                ...
                args=("nmap", "-sV", "-sC", "-p139,445", "--script", "smb-enum-shares,smb-enum-users,smb-os-discovery", "{target_host}", "-oA", "{output_prefix}"),
                service_key="tcp/445",
